...
def reindex_pdb_by_sequence(sequence_ref, PDBtxt, chain_id):
    ...
    from birds.utilities.pdb2fasta import pdbtxt2seq
    ...
    from birds.utilities.NWalign import calcualte_score_gotoh, trace_back_gotoh
...
def reindex_pdb(startindex, infile, clean=True):
    ...
    if os.path.isfile(startindex):
        from birds.utilities.NWalign import readFastaOrRawSequence
